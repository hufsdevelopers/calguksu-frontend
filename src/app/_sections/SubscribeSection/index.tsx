        ...
        <Button
          ...
          onClick={() => {
            if (validateEmail(inputEmail) && selectedCalendarOption) {
              requestEmailSubscription(inputEmail, selectedCalendarOption.code, agreedPrivacyPolicy)
                .catch((e) => {
                  console.error(e);
                })
                .finally(() => moveDown());
          ...
          aria-invalid={!validateEmail(inputEmail)}
        >
          여기로 받을게요
        </Button>
        <SectionComment>
          진행하면 칼국수닷컴의&nbsp;
          <SectionCommentHighlight as={Link} href="/policies/privacy" target="_blank">
            개인정보처리방침
          </SectionCommentHighlight>
          에 동의하는 것으로 간주됩니다.
        </SectionComment>
